...
public class OrderCompletionReport implements Streamable<OrderLineCompletion> {
	...
	/**
	 * The completion status of an {@link LineItem}.
	 *
	...
	public static class OrderLineCompletion {
		...
		@NonNull LineItem orderLine;
		@NonNull CompletionStatus status;
		@NonNull Optional<String> message;

		public static OrderLineCompletion skipped(LineItem ordeLine) {
			return new OrderLineCompletion(ordeLine, CompletionStatus.SUCCEEDED, Optional.of("The order line was skipped."));
		}

		/**
		 * Creates an {@link OrderLineCompletion} representing the successful completion of an {@link LineItem}.
		 *
		 * @param orderLine must not be {@literal null}.
		 * @return
		 */
		public static OrderLineCompletion success(LineItem orderLine) {
			return new OrderLineCompletion(orderLine, CompletionStatus.SUCCEEDED, Optional.empty());
		}

		/**
		 * Creates an {@link OrderLineCompletion} representing an erroneous {@link LineItem} alongside an error message.
		 *
		 * @param orderLine must not be {@literal null}.
		 * @param message must not be {@literal null}.
		 * @return
		 */
		public static OrderLineCompletion error(LineItem orderLine, String message) {
		 ...
		 */
		public OrderLineCompletion onSuccess(Consumer<LineItem> action) {
